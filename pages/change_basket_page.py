...
class ChangeBasketPage(WebPage):
    ...
    backet_item = ManyWebElements(
        xpath='/html/body/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div[2]/table/tbody/tr')

    remove_items = WebElement(xpath = '/html/body/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[1]/a')